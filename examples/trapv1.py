...
async def handler(host: str, port: int, message: aiosnmp.SnmpV1TrapMessage) -> None:
...
if __name__ == "__main__":
    ...
    trap_server = aiosnmp.SnmpV1TrapServer(host="127.0.0.1", port=162, communities=("public",), handler=handler)
